...
--
-- Host: localhost
-- Generation Time: 05-Dez-2017 às 01:27
...
INSERT INTO `Agendamento` (`id_agenda`, `data`, `hora`, `nome_medico`, `nome_paciente`) VALUES
(1, '0000-00-00', '00:00:00', 'Jaime Chaves', 'Pedro'),
(2, '2017-10-30', '10:40:00', 'Pedro', 'lucas'),
(3, '2017-11-30', '16:00:00', 'Pedro', 'Jaime Chaves'),
(4, '2017-10-26', '15:00:00', 'jaime', 'Jaime Da Cruz Chaves'),
(5, '0000-00-00', '10:45:00', 'Jaime', 'fernanda'),
(23, '2017-11-01', '10:10:00', 'Jaime', 'matheus'),
(24, '2017-12-02', '09:00:00', 'Pedro', 'julia'),
(25, '2018-01-01', '10:10:00', 'Pedro', 'fernanda');
...
CREATE TABLE `anamnese` (
  ...
  `queixa_principal` varchar(1000) DEFAULT NULL,
  `historico` varchar(45) DEFAULT NULL,
  `problemas_renais` varchar(45) DEFAULT NULL,
  `problemas_cardiacos` varchar(45) DEFAULT NULL,
  ...
  `gravidez` varchar(5) DEFAULT NULL,
  `diabetes` varchar(5) DEFAULT NULL,
  `problemas_de_cicatrizacao` varchar(5) DEFAULT NULL,
  `ultiliza_medicamentos` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `anamnese` (`id_anamnese`, `id_agendamento`, `queixa_principal`, `historico`, `problemas_renais`, `problemas_cardiacos`, `problemas_articulares`, `problemas_respiratorios`, `problemas_gastricos`, `Alergia`, `hepatite`, `gravidez`, `diabetes`, `problemas_de_cicatrizacao`, `ultiliza_medicamentos`) VALUES
(6, 4, 'dor de cabeÃ§a', 'nÃ£o', 'nÃ£o', 'sim', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'sim', 'nao', 'nao', 'nao', 'nÃ£o'),
(7, 1, 'dor de cabeÃ§a', '', '', '', '', '', '', '', 'sim', 'sim', 'sim', 'sim', ''),
(8, 5, 'muita dor nas pernas', '', '', '', '', '', '', '', 'sim', 'sim', 'sim', 'sim', ''),
(10, 24, 'dor nas costa', 'comeÃ§ou a 4 meses atras ', 'nÃ£o', '', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'nao', 'nao', 'nao', 'nao', 'nÃ£o'),
(11, 2, 'dor de cabeÃ§a', 'comeÃ§ou a 4 meses atras ', 'nÃ£o', '', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'nÃ£o', 'nao', 'nao', 'nao', 'nao', 'nÃ£o'),
(12, 1, 'dor de cabeÃ§a', '', '', '', '', '', '', '', 'sim', 'sim', 'sim', 'sim', ''),
(13, 25, 'jaime', '', '', '', '', '', '', '', 'sim', 'sim', 'sim', 'sim', '');
...
CREATE TABLE `atestado` (
  ...
  `atestado` varchar(1000) DEFAULT NULL,
  `id_agendamento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `atestado` (`id_atestado`, `atestado`, `id_agendamento`) VALUES
(4, 'ficou bom!', 4),
(5, 'morreu', 5),
(6, 'passou por aqui', 1),
(7, 'ficou bom! ', 24);
...
CREATE TABLE `Cadastro_Medico` (
  ...
  `especialidades` varchar(45) DEFAULT NULL,
...
INSERT INTO `Cadastro_Medico` (`id_medico`, `medico`, `endereço`, `bairro`, `cidade`, `estado`, `cep`, `complemento`, `cpf`, `rg`, `data_de_nascimento`, `naturalidade`, `nacionalidade`, `telefones`, `celular`, `trabalho`, `especialidades`, `crm`, `id_agenda`, `usuario`, `email`, `senha`) VALUES
(6, 'joão', NULL, NULL, '', NULL, NULL, NULL, 0, 0, '0000-00-00', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', '', ''),
(3, 'Jaime da Cruz Chaves', 'Rua Jose Inacio', 'Mundo Novo', '', 'Maranhão', '65923000', 'Perto da escola', 661229530, 324235423, '1993-12-06', 'Amarantino', 'Brasileiro', 84127618, 84127618, NULL, NULL, '1212', NULL, 'jaime', 'jaimechaves10@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b'),
(2, 'pedro alencar', NULL, NULL, '', NULL, NULL, NULL, 0, 0, '1969-10-17', NULL, NULL, NULL, NULL, NULL, NULL, '1313', NULL, 'pedro', 'pedro@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b'),
(4, 'Jaime Chaves', NULL, NULL, '', NULL, NULL, NULL, 0, 0, '0000-00-00', NULL, NULL, NULL, NULL, NULL, NULL, '1616', NULL, 'jaime chaves', 'jaimechaves10@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b');
...
CREATE TABLE `Cadastro_Paciente` (
  ...
  `cpf` int(11) NOT NULL,
  `rg` int(11) NOT NULL,
  `data_nacismento` int(11) NOT NULL,
  `naturalidade` varchar(45) DEFAULT NULL,
  `nacionalidade` varchar(45) DEFAULT NULL,
...
INSERT INTO `Cadastro_Paciente` (`nome`, `endereco`, `bairro`, `cidade`, `estado`, `cep`, `complemento`, `cpf`, `rg`, `data_nacismento`, `naturalidade`, `nacionalidade`, `email`, `telefone`, `celular`, `telefone_trabalho`, `especialidades`, `nome_pai`, `nome_mae`, `tipo_sanguineo`, `id_paciente`, `id_agenda`) VALUES
('Jaime Chaves', 'Rua Jose', 'Mundo', 'amarante', 'Ma', '65953000', 'rua', 661229530, 343432213, 121212, 'Amarante', 'Brasileiro', 'jaimechaves10@gmail.com', 84127618, 84127618, '84127618', 'nenhuma', 'edmilsom', 'sandra', 'B', 1, 0),
('lucas', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 2, NULL),
('fernanda', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 3, NULL),
('maria', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 4, NULL),
('julia', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 5, NULL),
('matheus', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 6, NULL),
('juliana', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 7, NULL),
('sandra', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 8, NULL),
('edmilsom', NULL, NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 9, NULL);
...
INSERT INTO `evolucao` (`id_evolucao`, `evolucao`, `id_agendamento`) VALUES
(1, 'melhorando lentamente', 5),
(2, 'nenhuma evoluÃ§Ã£o', 4),
(3, 'em observaÃ§Ã£o ainda', 1),
(4, 'melhora de 100% segundo o paciente ', 2),
(6, 'com o tempo a dor  vem diminuindo ', 24);

-- --------------------------------------------------------

--
-- Estrutura da tabela `hipoteze`
--

CREATE TABLE `hipoteze` (
  `id_hipotese` int(11) NOT NULL,
  `hipotese` varchar(240) NOT NULL,
  `observacao` varchar(240) NOT NULL,
  `id_agendamento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `hipoteze`
--

INSERT INTO `hipoteze` (`id_hipotese`, `hipotese`, `observacao`, `id_agendamento`) VALUES
(5, 'nada a declarar', 'nada a declarar', 4),
(6, 'problema de vista', 'nenhuma observaÃ§Ã£o', 1),
(7, 'problemas de vista', 'odres de cabeÃ§a quando esta estudando olhando para notebook', 2),
(9, 'velhice ', 'nenhuma observaÃ§Ã£o', 24);

-- --------------------------------------------------------

--
-- Estrutura da tabela `presquicao`
--

CREATE TABLE `presquicao` (
  `id_presquicao` int(11) NOT NULL,
  `presquicao` varchar(200) NOT NULL,
  `id_agendamento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `presquicao`
--

INSERT INTO `presquicao` (`id_presquicao`, `presquicao`, `id_agendamento`) VALUES
(7, 'diarreia', 4),
(8, 'fazer exames medicos', 1),
(9, 'fazer exames de vista', 2),
(10, 'fazer execÃ­cio diariamente  ', 24);
...
INSERT INTO `sinais_vitais` (`id_sinais`, `data`, `hora`, `altura`, `peso`, `IMC`, `temperatura`, `dor`, `id_agendamento`) VALUES
(5, '2017-11-28', '14:50:00', 180, 90, 2.4, 34, 'nemhuma', 4),
(6, '2017-12-01', '08:00:00', 170, 87, 2.4, 30, 'na cabeÃ§a', 1),
(7, '2018-01-01', '14:00:00', 80, 100, 2.5, 30, 'nas costa', 2),
(8, '2017-12-07', '10:57:00', 190, 110, 5, 33, 'nas costa', 24),
(9, '2017-01-04', '08:00:00', 190, 80, 2.4, 36, 'de cabeÃ§a', 3);
...
ALTER TABLE `Agendamento`
  ...
  ADD KEY `nome_paciente` (`nome_paciente`);
...
ALTER TABLE `atestado`
  ...
  ADD KEY `atestado_agenda` (`id_agendamento`);

--
-- Indexes for table `Cadastro_Medico`
--
ALTER TABLE `Cadastro_Medico`
  ADD PRIMARY KEY (`crm`),
  ADD KEY `id_agenda_idx` (`id_agenda`),
...
ALTER TABLE `evolucao`
  ...
  ADD KEY `agenda_evolucao` (`id_agendamento`);

--
-- Indexes for table `hipoteze`
--
ALTER TABLE `hipoteze`
  ADD PRIMARY KEY (`id_hipotese`),
  ADD KEY `agenda_hipotese` (`id_agendamento`);

--
-- Indexes for table `presquicao`
--
ALTER TABLE `presquicao`
  ADD PRIMARY KEY (`id_presquicao`),
  ADD KEY `prescricao` (`id_agendamento`);
...
ALTER TABLE `sinais_vitais`
  ...
  ADD KEY `agenda_sinais` (`id_agendamento`);
...
--
ALTER TABLE `anamnese`
  MODIFY `id_anamnese` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `atestado`
--
ALTER TABLE `atestado`
  MODIFY `id_atestado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `Cadastro_Medico`
--
ALTER TABLE `Cadastro_Medico`
...
--
ALTER TABLE `evolucao`
  MODIFY `id_evolucao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `hipoteze`
--
ALTER TABLE `hipoteze`
  MODIFY `id_hipotese` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `presquicao`
--
ALTER TABLE `presquicao`
  MODIFY `id_presquicao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `sinais_vitais`
--
ALTER TABLE `sinais_vitais`
  MODIFY `id_sinais` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `anamnese`
  ADD CONSTRAINT `anamnese_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);

--
-- Limitadores para a tabela `atestado`
--
ALTER TABLE `atestado`
  ADD CONSTRAINT `atestado_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);

--
-- Limitadores para a tabela `evolucao`
--
ALTER TABLE `evolucao`
  ADD CONSTRAINT `evolucao_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);

--
-- Limitadores para a tabela `hipoteze`
--
ALTER TABLE `hipoteze`
  ADD CONSTRAINT `hipoteze_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);

--
-- Limitadores para a tabela `presquicao`
--
ALTER TABLE `presquicao`
  ADD CONSTRAINT `presquicao_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);

--
-- Limitadores para a tabela `sinais_vitais`
--
ALTER TABLE `sinais_vitais`
  ADD CONSTRAINT `sinais_vitais_ibfk_1` FOREIGN KEY (`id_agendamento`) REFERENCES `Agendamento` (`id_agenda`);
COMMIT;
