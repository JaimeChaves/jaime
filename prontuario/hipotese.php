...
include_once("modelo/Hipotese.class.php");
...
<html>
    ...
    <section>
        ...
        <form action='controle/Hipotese.controle.php' method='post'> 
            <div class="row">    
            ...
            <div class="row">    
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label" for="txtMensagem">Hipótese</label>
                        <textarea class="form-control" rows="6" id="hipotese" name="hipotese"></textarea>
                    </div>
                </div>
                <div class="row">    
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label" for="txtMensagem">Observações</label>
