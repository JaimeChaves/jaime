...
include_once("modelo/Evolucao.class.php");
...
<html>
    ...
    <section>
        ...
        <form action='controle/Evolucao.controle.php' method='post'>
             <div class="row">    
           ...
           <div class="row">    
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label" for="txtMensagem">Evolução</label>
                        <textarea class="form-control" rows="6" id="evolucao" name="evolucao"></textarea>
                    </div>
                </div> 
            </div>                   
