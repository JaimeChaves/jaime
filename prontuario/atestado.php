...
include_once("modelo/Atestado.class.php");
...
<html>
    ...
    <section>
        ...
        <form action='controle/Atestado.controle.php' method='post'>
             <div class="row">    
            ...
            <div class="row">    
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label" for="txtMensagem">Atestado</label>
                        <textarea class="form-control" rows="6" id="atestado" name="atestado"></textarea>
                    </div>
                </div> 
            </div>            
